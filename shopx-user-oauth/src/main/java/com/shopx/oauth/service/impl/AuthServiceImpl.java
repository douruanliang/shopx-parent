package com.shopx.oauth.service.impl;
...
public class AuthServiceImpl implements AuthService {
    ...
    public AuthToken login(String username, String password, String clientId, String clientSecret, String grandType) {
        //申请令牌
        AuthToken authToken = applyToken(username, password, clientId, clientSecret, grandType);
        if (authToken == null) {
     ...
     * @return
     */
    private AuthToken applyToken(String username, String password, String clientId, String clientSecret, String grandType) {
        //选中认证服务的地址
